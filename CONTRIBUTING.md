...
To report identified bugs, please fill a.[GitHub bug report issue](https://github.com/whiteprints-tests/test-rtd-darwin-py310-test/issues/new?template=bug_report.yml).
...
To request features, please [open a discussion](https://github.com/whiteprints-tests/test-rtd-darwin-py310-test/discussions/categories/ideas)

Once the enhancement has been discussed, fill a [GitHub feature issue](https://github.com/whiteprints-tests/test-rtd-darwin-py310-test/issues/new?template=feature_request.yml).
...
[Pull Request]: https://github.com/whiteprints-tests/test-rtd-darwin-py310-test/pulls
[issue]: https://github.com/whiteprints-tests/test-rtd-darwin-py310-test/issues
