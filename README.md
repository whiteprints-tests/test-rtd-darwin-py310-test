...
# test rtd darwin py310-test

![test rtd darwin py310-test banner](docs/_static/banner.svg)
<div align="center">
    <p>
        <em>
            A Python package.
    ...
    <p>
        ...
        <a href="https://github.com/whiteprints-tests/test-rtd-darwin-py310-test/discussions"><img alt="GitHub Discussions" src="https://img.shields.io/github/discussions/whiteprints-tests/test-rtd-darwin-py310-test.svg?logo=GitHub"></a>
        ...
        <a href='https://readthedocs.org/projects/test-rtd-darwin-py310-test/'><img src='https://readthedocs.org/projects/test-rtd-darwin-py310-test/badge/?version=latest' alt='Documentation Status' /></a>
...
See: https://test-rtd-darwin-py310-test.readthedocs.io/en/stable/.
