...
project = "test rtd darwin py310-test"
...
release = metadata.version("test_rtd_darwin_py310_test")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-rtd-darwin-py310-test",
            "icon": "fa-brands fa-square-github",
            "type": "fontawesome",
        },
        {
            "name": "ReadTheDocs",
            "url": "https://readthedocs.org/projects/test-rtd-darwin-py310-test",
