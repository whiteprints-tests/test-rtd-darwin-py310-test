...
The project is hosted on [https://github.com/whiteprints-tests/test-rtd-darwin-py310-test.git](https://github.com/whiteprints-tests/test-rtd-darwin-py310-test.git).
